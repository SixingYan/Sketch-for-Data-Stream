...
[dataP+'tr_fre_4ij_refined',
 dicPath+'tr_fre_0.2.txt',dicPath+'tr_fre_0.1.txt',dicPath+'tr_fre_0.05.txt',
 2,29643457,dicPath+'tr_top2000',
 dicPath+'tr_nfo.pk',dicPath+'tr_efo.pk',
 dicPath+'tr_result.txt','rad',],
]
...
##########################################gSketch
# 1. get and sort
nfoList = gS_StreamList.getSortedStream(samplePath) #nodeFreqOdList
