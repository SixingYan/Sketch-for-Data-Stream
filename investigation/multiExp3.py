...
data = expSketch('D:/google desk PC/graph_freq_comp18.txt',338239)
savePickle('D:/google desk PC/pickle/stdList_value_comp18',data[0])
savePickle('D:/google desk PC/pickle/stdList_point_comp18',data[1])
savePickle('D:/google desk PC/pickle/result_comp18_std',result)
print(result)