#import os;os.chdir('D:/google desk PC');import detailsSample_top
    ...
    with open(filename, 'r') as f:
        ...
        for line in f:
            ...
            if len(line)>0:
                ...
                if len(queryList)>500:
                    minV = min(queryList, key= lambda x: x[2])
                    if freq>minV[2]:
                        indx = queryList.index(minV);queryList[indx] = (s,t,freq)
                else:
                    queryList.append((s,t,freq))
getQueryList()
...
savePickle('D:/google desk PC/pickle/ip_top500_500_resultDict',resultDict)
savePickle('D:/google desk PC/pickle/ip_top500_500_obDict',obDict)
